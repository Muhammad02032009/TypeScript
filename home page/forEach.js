...
let DeleteCheckBtn = document.querySelector('.DeleteCheckBtn');
    ...
    data.forEach((el) => {
        ...
        check.onclick = () => {
            if (check.checked) {
                ...
                arr = arr.filter((id) => id != el.id.toString());
            }
            DeleteCheckBtn.onclick = () => {
                arr.forEach((id) => {
                    (0, functions_js_1.deleteUSer)(id.toString());
                    arr = [];
                });
            };
        };
        ...
        delBtn.onclick = () => {
            (0, functions_js_1.deleteUSer)(el.id.toString());
        };
